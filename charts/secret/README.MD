...
helm template secrets-manual ./charts/secret -f ./charts/secret/values-secret.yaml

#Установка/обновление Helm релиза секретов
helm upgrade --install secrets-manual ./charts/secret -f ./charts/secret/values-secret.yaml
